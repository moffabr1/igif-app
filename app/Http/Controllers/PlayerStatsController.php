...
//        dd($cumulativeData['total_eagles']);
        ...
        return View::make('igif.player.stats.ScoreCategories', compact('cumulativeData'));
...
//        return($fw_hit_data);
        ...
        return View::make('igif.player.stats.fairways')
            ->with([
//                'dates' => array_pluck($fw_hit, 'round_date'),
//                'fw_hit' => array_pluck($fw_hit, 'fw_hit')
