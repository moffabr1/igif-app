    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <canvas id="cline" width="552" height="346" style="width: 276px; height: 173px;"></canvas>				</div>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <canvas id="cbar" width="552" height="346" style="width: 276px; height: 173px;"></canvas>				</div>
            </div>
